     ...
     decoration: BoxDecoration(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Text("SIDDHARTH",style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold,decoration:TextDecoration.none,color: Color(0xff075E54)),textAlign: TextAlign.center,)
        ],
      ),
    );
  }
